...
module("snippets", "engine-main-custom-environment")
...
module("snippets", "thymeleaf-auto-reload")
...
module("snippets", "client-io-interop")
module("snippets", "server-io-interop")
...
module("snippets", "auth-form-session-nested")
...
module("snippets", "json-kotlinx-openapi")
...
module("snippets", "client-custom-plugin-auth")
module("snippets", "client-custom-plugin-data-transformation")
...
module("snippets", "proguard")
module("snippets", "embedded-server-multiple-connectors")
