...
<var name="ktor_version_catalog_name" value="ktorLibs.server.pebble"/>
...
To use the template for the specified [route](server-routing.md), pass `PebbleContent` to the `call.respond` method in the following way:
