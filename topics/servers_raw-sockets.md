...
In addition to HTTP handling for the [server](A_Ktor_Application.xml) and the [client](clients_index.md), Ktor supports client and server, TCP and UDP raw sockets.
