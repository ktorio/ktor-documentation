...
> In v2.0.0, the `Locations` plugin is deprecated. Use the [Resources](server-resources.md) plugin instead.
>
{type="note"}
...
The parameters must be of any type supported by the [Data Conversion](server-data-conversion.md) plugin.
