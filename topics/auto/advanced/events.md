...
[//]: # (keywords: >-)
[//]: # (EventDefinition events monitoring monitors: EventDefinition events monitoring monitors)
[//]: # (ApplicationStarting ApplicationStarted ApplicationStopPreparing ApplicationStopping ApplicationStopped: ApplicationStarting ApplicationStarted ApplicationStopPreparing ApplicationStopping ApplicationStopped)
[//]: # (subscribing unsubscribing raising raise events dispatching: subscribing unsubscribing raising raise events dispatching)
