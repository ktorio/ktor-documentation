...
> Note that [connection and SSL settings](Configuration-file.topic#configuration-file) are not in effect when a Ktor application is deployed inside a servlet container. 
